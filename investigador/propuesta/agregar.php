    ...
    <script type="text/javascript">
        function validar(f) {
            ...
            if(f.duracion.value == '0'){
                alert('Por favor seleccione la duracion de la Propuesta');
                f.duracion.focus();
                condicion=false;
                return false;
            }
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
                ...
                <form class="form-inline" role="form" method="post" name="for" id="for"  onSubmit="return validar(this)" action="../../controller/propuesta.php?opc=1">
                    <div class="form-group">
                        <br/>
                            <input name="id_investigador" type="hidden" value="<?php echo $id?>"/>
