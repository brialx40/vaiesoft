  ...
  <div class="box col-md-12">
    <div class="box-inner">
       ...
       <br/><br/> 
        ...
        <label class="control-label" style="width: 70%; font-weight: normal; color:red;" for="inputSuccess4">$ <?php echo number_format(($Propuesta['presupuesto']), 2, ",", ".")?></label>
       <br/><br/>         
      
        <a class="btn btn-default" href="agregarR.php?id=<?php echo $id?>&inv=<?php echo $id_investigador?>">
            Agregar
        </a>
        <a class="btn btn-default" href="contrapartida.php?id=<?php echo $id?>&inv=<?php echo $id_investigador?>">
        ...
        <?php       
         ...
         foreach($rubros as $f):             
            ...
            echo '<tr>
                ...
                <a href="editar.php?id='.$f['id_pru'].'&inv='.$id_investigador.'">
  ...
  ?>
      ...
      <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
            <a class="btn btn-default" href="editar_contrapartida.php?id=<?php echo $contr['id_pru']?>&inv=<?php echo $id_investigador?>">
                Editar
            </a><br/><br/>
           <table class="table table-striped table-bordered responsive">
            <thead>
