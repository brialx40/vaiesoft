            ...
            <div class="box-content">
                ...
                <form class="form-inline" role="form" method="post" name="form1" id="form1" action="../../../controller/propuestaContrapartida.php?opc=2">
                    <div class="form-group">
                      <input name="id_propuesta" type="hidden" value="<?php echo $contrapartida['id_propuesta']?>"/>
                      <input name="id_pru" type="hidden" value="<?php echo $id_pru?>"/>
                      <input name="id_investigacion" type="hidden" value="<?php echo $id_investigacion?>"/>
                      ...
                      <?php
                        ...
                        for($i=0; $i < count($rubros) -1; $i=$i+2){
                         ...
                         <input type="text" class="form-control" name="txtvalor<?php echo $rubros[$i]?>" required onkeypress="ValidaSoloNumeros()" value="<?php echo $rubros[$i+1];?>">
                         <br/><br/>
                          <?php  
                        }     
