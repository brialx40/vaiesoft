...
$id=$_GET['id'];
$prop = new Propuesta();
$propuestas=$prop->listarPropuestaPorInvestigador($id);
        ...
        <?php       
         ...
         foreach($propuestas as $prop): 
            echo '<tr>';
                ...
                <a href="ver.php?id='.$prop['id_propuesta'].'&inv='.$id.'">
                   <img alt="Ver" title="Ver" src="../../img/ver.png" height="19" width="19"/>
                </a>
                <a href="editar.php?id='.$prop['id_propuesta'].'&inv='.$id.'">
                    <img alt="Editar" title="Editar" src="../../img/editar.gif" height="18" width="18"/>
                </a>
                <a href="../../controller/propuestaRubro.php?opc=4&id='.$prop['id_propuesta'].'&inv='.$id.'">
